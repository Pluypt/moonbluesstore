    ...
    return (
        <div className="bg-urban-white min-h-screen pb-safe">
            <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 py-0 sm:py-12 pt-16 sm:pt-24">
                ...
                <div className="fixed bottom-[64px] md:bottom-0 left-0 w-full bg-transparent p-4 z-40 pb-safe md:static md:bg-transparent md:px-0 md:py-16 md:z-auto mb-8 md:mb-16">
